...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By jinusir' : process.env.ALL_CAPTION,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'JINUSIR BOT' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.ibb.co/wMm12js/Pics-Art-10-02-02-56.jpg' : process.env.ALL_IMG,
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://instagram.com/jinu__777?utm_medium=copy_link' : process.env.SOCIAL_MEDIA,
